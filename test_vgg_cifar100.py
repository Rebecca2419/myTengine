...
for item in filelist:
    ...
    if(item.endswith('.png')):
        ...
        cmd="timeout 0.6 ./build/install/bin/tm_classification -s 0.01938492,0.01966684,0.01951029 -w 125.307,122.961,113.8575 \
            -g 32,32 -m models_convert/VGG16_cifar100.tmfile -i images/test_cifar100/" + item + " >&" + image + ".txt"
